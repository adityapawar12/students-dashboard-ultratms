...
function StudentHorizontal({ student }: { student: StudentInterface }) {
  ...
  return (
    ...
    >
      <CardHeader className="flex flex-row justify-between h-full p-4">
        ...
        <div className="w-auto flex flex-col justify-evenly items-center gap-2">
          <Button
...
export default StudentHorizontal;
